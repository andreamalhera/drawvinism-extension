// ==UserScript==
// @name         DrawVinism 🧬
// @namespace    https://github.com/andreamalhera/drawvinism-extension
// @version      1.0
// @match        https://app.diagrams.net/*
// @match        https://*.diagrams.net/*
// @match        https://*.draw.io/*
// @run-at       document-end
// @updateURL    https://raw.githubusercontent.com/andreamalhera/drawvinism-extension/main/drawvinism.user.js
// @downloadURL  https://raw.githubusercontent.com/andreamalhera/drawvinism-extension/main/drawvinism.user.js
// ==/UserScript==
...
(function initDrawVinism() {
    ...
    Draw.loadPlugin(function(ui) {
        ...
        ui.actions.put('drawVinismAbout', new Action('About DrawVinism 🧬', function() {
            ...
            content.innerHTML =
                '<h2 style="margin-top:0; color:#2b579a;">DrawVinism 🧬 v1.0</h2>' +
